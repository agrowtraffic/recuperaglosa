/* ============================================================
   ...
   Fonte: Tabela-38-Terminologia-de-mensagens-glosas-negativas-e-outras.pdf
   603 códigos, transcritos literalmente (maiúsculas do original).

   O termo aqui é o texto OFICIAL do código. É ele que deve ser citado no
   recurso: alegar um motivo diferente do que a operadora usou é o caminho
   mais curto para o indeferimento.

   Para regenerar: extrair o texto do PDF e rodar o gerador (ver
   scratchpad/gerar-tabela38-ts.js no histórico do projeto).
   ============================================================ */

export const TABELA_38: Record<string, string> = {
...
/** Faixas de código da Tabela 38, na ordem em que o documento as apresenta. */
export const FAIXAS_TABELA_38 = [
  { prefixo: '10', titulo: 'Beneficiário e elegibilidade' },
  { prefixo: '11', titulo: 'Protocolo' },
  { prefixo: '12', titulo: 'Credenciado / prestador' },
  { prefixo: '13', titulo: 'Guia e preenchimento' },
  { prefixo: '14', titulo: 'Autorização e senha' },
  { prefixo: '15', titulo: 'Dados clínicos' },
  { prefixo: '16', titulo: 'Atendimento e internação' },
  { prefixo: '17', titulo: 'Cobrança, valores e prazo' },
  { prefixo: '18', titulo: 'Procedimento' },
  { prefixo: '19', titulo: 'Acomodação e permanência' },
  { prefixo: '20', titulo: 'Material' },
  { prefixo: '21', titulo: 'Medicamento' },
  { prefixo: '22', titulo: 'OPME' },
  { prefixo: '23', titulo: 'Gases medicinais' },
  { prefixo: '24', titulo: 'Taxas e aluguéis' },
  { prefixo: '25', titulo: 'Procedimento em série' },
  { prefixo: '26', titulo: 'Honorários e codificação' },
  { prefixo: '27', titulo: 'Exames' },
  { prefixo: '28', titulo: 'Pacotes' },
  { prefixo: '29', titulo: 'Revisão de glosa' },
  { prefixo: '30', titulo: 'Odontologia' },
  { prefixo: '31', titulo: 'Regras de autorização' },
  { prefixo: '50', titulo: 'Comunicação e padrão TISS' },
] as const;
